...
1. Any Method is Allowed
    - removed check for allowed methods. ANY value for HTTP verb is now acceptable.
    - if the request has a body, then we make the request method POST, otherwise we make it GET.
2. 
"""
